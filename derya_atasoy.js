    ...
    const now = Date.now(); 
    const oneHour = 60 * 60 * 1000; // 1 hour local storage cache

    // If cache is valid, get it from localStorage
    ...
    // Ebebek websites banner will be replaced with the design
    ...
    style.textContent = `
        ...
        border: 2px solid #1976d2;
            ...
            @media (max-width: 1380px) { #product-list li { flex: 0 0 220px; } #product-list img { height: 220px; } }
            @media (max-width: 1200px) { #product-list li { flex: 0 0 200px; } #product-list img { height: 200px; } }
            @media (max-width: 1024px) { #product-list li { flex: 0 0 180px; } #product-list img { height: 180px; } }
            @media (max-width: 900px) { #product-list li { flex: 0 0 160px; } #product-list img { height: 160px; } }
            @media (max-width: 768px) { #product-list li { flex: 0 0 150px; } #product-list img { height: 150px; } }
            @media (max-width: 600px) { #product-list li { flex: 0 0 140px; } #product-list img { height: 140px; } }
    ...
    products.forEach((product) => {
        ...
        const decimalPart = priceParts[1] ? `,${priceParts[1]}` : ",00";
